...
export const Calendar = ({ token, setToken, apiSource = 'instagram', onNavigate }) => {
  ...
  useEffect(() => {
    // Clear events and notifications when the source changes
    setEvents([]);
    setNotifications([]);

    // Instagram does not have a public calendar API, so we leave this empty.
    if (apiSource === 'instagram') {
      // Intentionally show an empty calendar
    }
      ...
      <div className="calendar-container">
        <div className="calendar-main">
          <FullCalendar
            ...
            events={events} // This will be an empty array for Instagram
            height={800}
            dayMaxEventRows={3}
