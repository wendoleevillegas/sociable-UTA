...
const CreatePost = ({ token, user, apiSource, onNavigate }) => {
    ...
    const handleSchedule = () => {
        ...
        // You might want to toggle the schedule section or open a modal here
        setIsScheduled(prev => !prev); // Example: Toggle the schedule section visibility
    };
                    ...
                    <div className="form-content"> {/* Use class from CreatePost.css */}
                        ...
                        {isScheduled && ( // Conditionally render schedule options
                           <div className="schedule-section form-section">
                             ...
                             <div className="schedule-platform-group"> {/* Use new class if needed */}
                               {selectedPlatforms.map(platform => (
                               ...
                               <button type="button" className="active-times-button">
                    ...
                    <div className="preview-panel"> {/* Use class from CreatePost.css */}
                         <div className="preview-header">
                             <div className="preview-brand">
                                 ...
                                 {/* Example Badge */}
                                 {/* <span className="preview-story-badge">+ Story</span> */}
                             </div>
