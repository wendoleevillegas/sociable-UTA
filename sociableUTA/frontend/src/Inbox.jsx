...
export const Inbox = ({ token, apiSource = 'instagram', onNavigate }) => {
  ...
  const platformConfig = { name: 'Instagram' }; // Simplified for this example
        ...
        <div className="inbox-layout">
          <div className="inbox-message-list">
            ...
            <div className="inbox-messages">
              ...
              {/* ... (message mapping logic would go here if there were messages) ... */}
            </div>
          </div>
          <div className="inbox-message-detail">
            ...
            {/* ... (selected message logic would go here) ... */}
          </div>
        </div>
      </div>
    </div>
