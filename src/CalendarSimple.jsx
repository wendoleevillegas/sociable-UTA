...
import { fetchPlatformNotifications, fetchPlatformCalendarEvents } from './ApiDataService';
import { NotificationPanel } from './NotificationPanel';
import './Calendar.css';

export const CalendarSimple = ({ token, setToken, apiSource = 'instagram', onNavigate }) => {
